...
void Manta::MeshPainter::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        auto *_t = static_cast<MeshPainter *>(_o);
        Q_UNUSED(_t)
        switch (_id) {
...
QT_INIT_METAOBJECT const QMetaObject Manta::MeshPainter::staticMetaObject = { {
    &LockedObjPainter::staticMetaObject,
    qt_meta_stringdata_Manta__MeshPainter.data,
    qt_meta_data_Manta__MeshPainter,
    qt_static_metacall,
    nullptr,
    nullptr
} };
