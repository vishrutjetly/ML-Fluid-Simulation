...
void Manta::TextCheckbox::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        auto *_t = static_cast<TextCheckbox *>(_o);
        Q_UNUSED(_t)
        switch (_id) {
...
QT_INIT_METAOBJECT const QMetaObject Manta::TextCheckbox::staticMetaObject = { {
    &QCheckBox::staticMetaObject,
    qt_meta_stringdata_Manta__TextCheckbox.data,
    qt_meta_data_Manta__TextCheckbox,
    qt_static_metacall,
    nullptr,
    nullptr
} };
...
QT_INIT_METAOBJECT const QMetaObject Manta::TextSlider::staticMetaObject = { {
    &QSlider::staticMetaObject,
    qt_meta_stringdata_Manta__TextSlider.data,
    qt_meta_data_Manta__TextSlider,
    qt_static_metacall,
    nullptr,
    nullptr
} };
