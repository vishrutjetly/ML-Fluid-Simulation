...
QT_INIT_METAOBJECT const QMetaObject Manta::ParticlePainter::staticMetaObject = { {
    &LockedObjPainter::staticMetaObject,
    qt_meta_stringdata_Manta__ParticlePainter.data,
    qt_meta_data_Manta__ParticlePainter,
    qt_static_metacall,
    nullptr,
    nullptr
} };
