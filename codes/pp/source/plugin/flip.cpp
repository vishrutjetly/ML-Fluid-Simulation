...
#line 1 "/home/vishrut/Study/USC/Sem-1/CSCI 596: Scientific Computing and Visualization/project/mlflip-mod/source/plugin/flip.cpp"
/******************************************************************************
 *
...
void sampleFlagsWithParticles( const FlagGrid& flags, BasicParticleSystem& parts, const int discretization, const Real randomness, const int ftype=FlagGrid::TypeFluid, const int randseed=9832) {
	...
	RandomStream mRand(randseed);
 
	FOR_IJK_BND(flags, 0) {
		if ( flags(i,j,k) & ftype ) {
...
void sampleLevelsetWithParticles( const LevelsetGrid& phi, const FlagGrid& flags, BasicParticleSystem& parts, const int discretization, const Real randomness, const bool reset=false, const bool refillEmpty=false, const int randseed=9832) {
...
void sampleShapeWithParticles( const Shape& shape, const FlagGrid& flags, BasicParticleSystem& parts, const int discretization, const Real randomness, const bool reset=false, const bool refillEmpty=false, const LevelsetGrid *exclude=NULL, const int randseed=9832) {
	const bool is3D = flags.is3D();
	const Real jlen = randomness / discretization;
	const Vec3 disp (1.0 / discretization, 1.0 / discretization, 1.0/discretization);
	RandomStream mRand(randseed);
...
void adjustNumber( BasicParticleSystem& parts, const MACGrid& vel, const FlagGrid& flags, int minParticles, int maxParticles, const LevelsetGrid& phi, Real radiusFactor=1. , Real narrowBand=-1., const Grid<Real>* exclude=NULL, const int randseed=9832) {
